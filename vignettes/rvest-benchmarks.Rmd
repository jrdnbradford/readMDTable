...
```{r benchmark-1, fig.alt = "Violin plot showing that extract_md_tables is faster than rvest"}
...
```{r benchmark-2, fig.alt = "Violin plot showing that read_md_table is faster than rvest"}
...
```{r benchmark-3, fig.alt = "Violin plot showing that rvest is faster than extract_md_tables"}
...
```{r benchmark-4, fig.alt = "Violin plot showing that rvest is slighlty faster than read_md_table"}
