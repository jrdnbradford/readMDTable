...
Many sites (like GitHub) convert markdown tables into HTML tables, making both available. See the vignette [Benchmarking rvest](https://jrdnbradford.github.io/readMDTable/articles/rvest-benchmarks.html) to help determine if you should use readMDTable or rvest.
