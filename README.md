...
and returns a named list of tibbles (`"table_1"`, `"table_2"`, …). It
handles both pure-table content and mixed markdown documents containing
headings, paragraphs, and multiple tables.
